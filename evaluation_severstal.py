...
def main():
    ...
    conf_df.to_csv(os.path.join(output_dir, "confusion_matrix_only_text.csv"))
    ...
    metrics_df.to_csv(os.path.join(output_dir, "accuracy_metrics_only_text.csv"), index=False, float_format="%.4f")
